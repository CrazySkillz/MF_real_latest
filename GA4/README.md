...
- GA4 Benchmark whole-tab status is clean-certified and `PRODUCTION_READY` for exact deployed runtime SHA `650ce59c4b0d14a21a198e8a2effd0c3a6d1fccd` and the section-specific boundary. Reports is certified separately.
