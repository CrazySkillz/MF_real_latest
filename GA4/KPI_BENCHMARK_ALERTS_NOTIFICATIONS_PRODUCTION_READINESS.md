...
- The post-Commit-8 implementation documented in `Current Notifications Implementation Alignment (September 5, 2026)` below is unchanged through deployed runtime `bf078b0375def8146e1f51e5d2c2246c3c350018`. The later change prevents duplicate active canonical KPI creation and does not alter alert or notification semantics. Exact-current `ga4_mock` scheduler validation supports KPI/Overview recertification at that runtime; it does not reissue or modify the locked GA4 Benchmark certification.
