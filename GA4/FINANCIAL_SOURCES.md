...
- when a selected Salesforce value is mapped to a GA4/paid-platform campaign in Crosswalk, `Review Settings` must show the Salesforce value and mapped campaign name using the same `selectedCampaignMappings` state used by preview and save
