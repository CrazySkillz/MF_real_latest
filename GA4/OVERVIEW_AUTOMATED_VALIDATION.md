...
- inbox delivery; `sendTest: true` can call the test-send endpoint, but delivery is not certified without provider delivery events or actual inbox receipt
