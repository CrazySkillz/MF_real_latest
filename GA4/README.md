...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Clean certification status as of `2026-08-08` (`Europe/Amsterdam`): `PRODUCTION_READY` for exact deployed SHA `1ae85d88928e306e52f02d7a0e3c1ecd9ad5719e` and the recorded dependency/configuration boundary. Reports-owned behavior is outside this certification; relevant future changes require recertification.
- `GA4/REPORTS.md`
...
- GA4 Insights live-tab clean certification status as of `2026-08-08` (`Europe/Amsterdam`) is `PRODUCTION_READY` for exact deployed SHA `1ae85d88928e306e52f02d7a0e3c1ecd9ad5719e` and the recorded dependency/configuration boundary. `GA4/INSIGHTS_PRODUCTION_READINESS.md` is the sole controlling narrative source and `GA4/certifications/ga4-insights.json` is the machine record; relevant future changes invalidate this dated certification until recertified.
