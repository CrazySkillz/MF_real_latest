...
interface SimpleGoogleSheetsAuthProps {
  ...
  purpose?: 'spend' | 'revenue' | 'general' | 'linkedin_revenue' | 'meta_revenue' | 'google_ads_revenue' | 'instagram_revenue' | 'tiktok_revenue';
}
...
export function SimpleGoogleSheetsAuth({ campaignId, onSuccess, onError, selectionMode = 'replace', purpose = 'general' }: SimpleGoogleSheetsAuthProps) {
  ...
  const isRevenueConnector = purpose === 'revenue' || purpose === 'linkedin_revenue' || purpose === 'google_ads_revenue' || purpose === 'instagram_revenue' || purpose === 'tiktok_revenue';
