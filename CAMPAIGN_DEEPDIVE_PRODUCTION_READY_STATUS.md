...
Instagram revenue import is now explicitly planned as Commit 13N before report work and before Commit 14 final validation, because final Instagram production-readiness evidence should include the same explicit, source-scoped revenue attribution path proven for LinkedIn.
