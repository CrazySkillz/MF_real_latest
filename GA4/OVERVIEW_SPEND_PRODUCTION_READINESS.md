...
- Current Commit 12's historical chooser packet is committed as `23a4fdc0`. Whole-Overview Commit 5 (`5da5f41c`) later hid Google Sheets temporarily. Current Commit 21 now restores Google Sheets beside Google Ads and Upload CSV through the existing campaign-scoped atomic process path. Deployment and chooser visibility validation remain pending; retained-source reconnect and one automatic-update observation remain valid historical evidence.
