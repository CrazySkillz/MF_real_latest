...
describe("campaign Executive Summary regression guard", () => {
  ...
  it("renders one live-only Executive Summary section from aggregate availability", () => {
    ...
    expect(page).toContain("const hasWebsiteOutcomeTargetException = websiteOutcomeExceptionMetricKeys.length > 0;");
    ...
    expect(page).not.toContain('action: "Investigate below-target website outcomes"');
