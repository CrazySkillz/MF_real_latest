...
- in that table, Sessions, Users, Conversions, and GA4-native revenue use the fixed initial-import-to-latest-completed-day GA4 breakdown query, while exact campaign-matched imported revenue is source-to-date; the subtitle must disclose the cumulative boundary and imported provenance
