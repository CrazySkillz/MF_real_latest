...
2026-09-07 Campaign Breakdown revenue correction: prior deployed output combined `$43,668.50` native revenue from `2026-07-02` through `2026-09-06` with `$16,799.99` exact mapped imports, producing `$60,468.49`, while the GA4 Revenue card used the campaign creation-date fallback `2026-06-24` through `2026-09-06` and returned `$65,362.20`. Runtime `08d7abe5` retains Summary-aligned traffic from `2026-07-02`, queries native row revenue separately from `2026-06-24`, and then adds the mapped imports. Authenticated production validation confirmed 1,505 Sessions, 1,507 Users, and 193 Conversions; native revenue of `$20,315.40`, `$26,935.20`, and `$18,111.60`; exact mapped imports of `$99.99`, `$16,100.00`, and `$600.00`; and displayed revenue of `$20,415.39`, `$43,035.20`, and `$18,711.60`, totaling `$82,162.19`.
