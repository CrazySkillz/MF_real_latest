...
| Ad Comparison | GA4-native 30-completed-day campaign rows plus separate source-to-date imported provenance | live client props and guarded GA4/revenue APIs | Clean-certified for the live tab at exact deployed revision `1c410e271961638d80088b69a14eb874df90b881` under its normalized pinned dependency boundary. Reports-owned output is outside the tab boundary. |
