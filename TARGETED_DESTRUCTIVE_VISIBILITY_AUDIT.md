...
1. Legacy/stale route and schema/storage cleanup.
   ...
   Current progress: first report-route reachability inventory is complete. LinkedIn report routes are not frontend-called but remain scheduler-compatible legacy routes; Meta report routes are active shared Meta/Google Ads routes with no persisted platform discriminator.
