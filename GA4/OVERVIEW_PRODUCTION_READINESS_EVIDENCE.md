...
| Campaign Breakdown | Exact saved-campaign GA4 acquisition rows plus exact mapped imported campaign revenue | selected property/filter; fixed initial-import boundary through latest completed day; matched imports are source-to-date | Deployed API/UI/PDF parity passed. Native rows total 1,505 Sessions, 1,507 Users, 193 Conversions, and `$43,668.50`; rendered Revenue adds only exact campaign-matched imports. |
