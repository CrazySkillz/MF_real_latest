...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Clean certification status as of `2026-08-10` (`Europe/Amsterdam`): `PRODUCTION_READY` for exact deployed SHA `4f3b2b6f0fb47a76d4506888733b46233b6c90c4` and the recorded dependency/configuration boundary. Reports-owned behavior is outside this certification; relevant future changes require recertification.
- `GA4/REPORTS.md`
  Covers GA4 report creation, scheduling, downloads, report-library behavior, and current-state caveats. Current status: `PRODUCTION_READY` for exact deployed SHA `4f3b2b6f0fb47a76d4506888733b46233b6c90c4`; Campaign DeepDive is excluded.
- `GA4/REPORTS_PRODUCTION_READINESS.md`
  Canonical GA4 Reports-tab production-readiness source of truth. Current status: clean-certified and production-ready for exact deployed SHA `4f3b2b6f0fb47a76d4506888733b46233b6c90c4` and the recorded dependency/configuration boundary. Campaign DeepDive is outside this boundary.
