...
- scheduled and explicitly saved report configurations must appear in that same GA4-style report card list; one-off unscheduled reports are download-only unless a platform contract explicitly supports saving them
