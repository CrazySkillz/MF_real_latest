...
- downloaded Budget & Financial Analysis PDFs should include the selected web-tab section structure: Overview, ROI & ROAS, Cost Analysis, Budget Allocation, and Insights exports should each include their major live-tab subsections instead of a generic metric list
