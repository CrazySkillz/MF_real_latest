...
- **Budget & Financial Analysis**: A single campaign-wide financial page with Financial Position, Budget & Pacing, conditional Paid Media Efficiency, Allocation & Sources, and Executive Action. Aggregate Spend, Revenue, Profit, ROAS, ROI, CPA, and source provenance remain connected-source totals; budget-specific values use only verified dated Spend inside the selected budget period and fail closed when that derivative is unavailable.
