...
- GA4 Overview `Campaign Breakdown` preserves raw selected-property cumulative GA4 row metrics for Sessions, Users, Conversions, and GA4-native Revenue; it must not scale campaign rows to Summary card totals
