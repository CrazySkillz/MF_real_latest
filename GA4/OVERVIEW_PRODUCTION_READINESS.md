...
8. Current Commit 4.7: HubSpot clean-certification update remains pending. Do not mark HubSpot clean-certified until the missing provider/source-modal provenance is recorded and refresh/reprocess is either traced as not applicable through UI/API route evidence or validated separately. Do not use Google Sheets, CSV, KPI, Benchmark, Reports, or other source-family evidence as proof.
