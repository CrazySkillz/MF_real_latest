...
- new GA4 Google Sheets revenue/spend creation remains locally fail-closed without deleting or deactivating retained sources; the existing Spend source has post-publish reconnect and one automatic-update observation, while OAuth durability remains pending and Google Sheets Revenue remains on hold
