...
- For the whole-tab decisions, `GA4/OVERVIEW_KPIs_CERTIFICATION_2026-09-15.md` controls KPIs and `GA4/BENCHMARKS_PRODUCTION_READINESS.md` controls Benchmarks. KPIs are **PRODUCTION_READY** only for deployed application runtime `1c949dc9710f36b1760a3fbf7253037236b52e00`; Benchmarks retain their separate `a96ba06e21c9344c1767c960e702ac4a647dc5f1` boundary. Scheduled Reports delivery remains separately controlled by the Reports record.
