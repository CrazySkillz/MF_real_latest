...
- Legacy route/schema/storage cleanup: started with read-only route reachability inventory and active source-route access hardening. No legacy code has been removed.
