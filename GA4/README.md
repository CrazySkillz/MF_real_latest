...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Current status: `UNVERIFIED`; the prior `80ffc60c4ac38b8bb01a91373a6a41d552f066ad` certification is invalidated and the current deployed revision requires a new exact-SHA packet. Reports-owned behavior is outside this certification.
- `GA4/REPORTS.md`
...
- GA4 Insights live-tab status is `UNVERIFIED`; the prior `80ffc60c4ac38b8bb01a91373a6a41d552f066ad` certification is invalidated. `GA4/INSIGHTS_PRODUCTION_READINESS.md` is the sole controlling narrative source and `GA4/certifications/ga4-insights.json` is the machine record.
