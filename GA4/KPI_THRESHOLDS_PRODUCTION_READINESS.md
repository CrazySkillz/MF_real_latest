...
> Current durable whole-tab answer: GA4 KPIs are **UNVERIFIED** after shared consumed dependencies changed. Runtime `f7afeb2b98a56a3387156a3d7b9b99d5128a2980` remains historical evidence for its exact boundary only. Threshold behavior itself was not changed, and this historical threshold evidence cannot broaden the current boundary.
