...
Current certification status: Shopify Revenue is **not production-ready and not clean-certified**. `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md` is canonical; the packets below remain bounded historical evidence only.
