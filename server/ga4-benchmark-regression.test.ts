...
describe("GA4 Benchmark regression guard", () => {
  ...
  it("keeps the historical certification bounded and locks the current production certification", () => {
    ...
    expect(record).toMatchObject({
      ...
      reviewedBaseGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
      reviewedImplementationGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
      certifiedGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
      candidateRevision: {
        baseGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
        runtimeGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
        deployedEvidenceGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
        currentDeployedGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
        currentDeploymentChangeClass: "exact_current_runtime_revalidation",
    ...
    expect(record.currentLocalReleaseCandidateGate).toMatchObject({
      ...
      implementationGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
      focusedFilesPassed: 28,
      focusedTestsPassed: 310,
    ...
    expect(record.currentDeployedReleaseCandidateGate).toMatchObject({
      ...
      currentDeployedGitSha: "a96ba06e21c9344c1767c960e702ac4a647dc5f1",
      currentDeploymentChangeClass: "exact_current_runtime_revalidation",
      mode: "authenticated_read_only_plus_authorized_scoped_lifecycle_and_alert_delivery",
      campaignCount: 1,
      benchmarkCount: 2,
      failureCount: 0,
      manualSchedulerResult: {
        benchmarksUpdated: 2,
        benchmarksSkipped: 0,
        benchmarksFailed: 0,
        crossCampaignUpdates: 0,
      },
      authorizedLifecycle: {
        temporaryBenchmarksCreated: 1,
        create: "passed",
        update: "passed",
        delete: "passed",
        existingBenchmarksPreserved: true,
      },
      alertDelivery: {
        provider: "mailgun-api",
        providerStatus: "delivered",
        subjectContains: "Benchmark threshold",
        inboxReceiptClaimed: false,
      },
    });
