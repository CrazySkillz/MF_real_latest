...
interface SimpleGoogleSheetsAuthProps {
  ...
  purpose?: 'spend' | 'revenue' | 'general' | 'linkedin_revenue' | 'meta_revenue' | 'google_ads_revenue' | 'instagram_revenue' | 'tiktok_revenue' | 'google_sheets_revenue' | 'custom_integration_revenue';
}
        ...
        <CardContent className="space-y-4">
          ...
          {selectedSpreadsheet && (
            <div className="space-y-2">
              ...
              <div className={`space-y-2 max-h-64 min-h-24 overflow-y-auto border border-border rounded-md p-3 ${isRevenueConnector ? "scrollbar-hide" : ""} ${purpose === "spend" ? "scrollbar-hide" : ""}`}>
                {isLoadingSheets ? (
