...
Next active HubSpot step: deploy and run Current Commit 4.12 `hubspotReportValuePack(...)` for the configured GA4 report. If 4.12 deployed report value evidence passes, proceed to Current Commit 4.13, HubSpot KPI/Benchmark value propagation.
