...
| --- | --- | --- | --- | --- | --- | --- |
| Google Sheets revenue | `Total Revenue`, revenue sources modal, Profit, ROAS, ROI, CPA, report payload values after the change | Closed for deployed campaign/source add/import of `dd5dc470-814d-42b9-af19-4b53ac7d08f8` after endpoint plus UI evidence (`$30,300`) | Required | Required if refresh/sync is exposed | Required | Partially proven only for Google Sheets revenue add/import on this campaign/source. Edit/update, refresh/reprocess, and delete/deactivate remain open. |
...
1. Next source family/action: Google Sheets revenue edit/update for the validated source `dd5dc470-814d-42b9-af19-4b53ac7d08f8`, changing the sheet revenue to one known expected amount and proving the same source ID updates in place without creating a duplicate. Do not refresh or delete in the same evidence packet.
