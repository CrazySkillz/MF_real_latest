...
- Shopify Revenue status (2026-08-08): **UNVERIFIED on the current revision**. The 2026-07-15 certification is bounded history; use `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md` for the controlling status and revalidation boundary.
- Google Sheets/Upload CSV Revenue status (2026-08-08): **both are UNVERIFIED on the current revision**. Use `GA4/OVERVIEW_REVENUE_PRODUCTION_READINESS.md` for the current currency fix, persisted-data boundary, and historical packets.
- HubSpot Revenue status (2026-08-08): **UNVERIFIED on the current revision** after a currency-relabeling defect invalidated H10d. Use `GA4/OVERVIEW_REVENUE_HUBSPOT_PRODUCTION_READINESS.md` for the controlling status, local forward fix, persisted-data boundary, and required revalidation.
...
- HubSpot-specific readiness is canonical in `GA4/OVERVIEW_REVENUE_HUBSPOT_PRODUCTION_READINESS.md`; H10d is historical and current status is UNVERIFIED.
- Shopify-specific readiness is canonical in `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md`; the 2026-07-15 packet is historical and current status is UNVERIFIED.
