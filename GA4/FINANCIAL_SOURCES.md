...
- editing an existing Google Sheets spend source should open from the saved mapping without auto-running a live sheet preview; users can use `Change sheet/tab` when they need to reconnect or change the sheet
