...
- Google Ads local/test-mode refinement is tracked separately in `GOOGLE_ADS_CONNECTED_PLATFORM_PRODUCTION_READY.md` and has passed local source-specific proof through Commit 24. Commit 25 fixes local live-OAuth campaign selection before the first metrics import.
