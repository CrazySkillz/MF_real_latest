...
- For the GA4 Benchmark whole-tab decision, `GA4/BENCHMARKS_PRODUCTION_READINESS.md` is controlling. GA4 Benchmarks are **PRODUCTION_READY** for the recorded boundary at deployed runtime `892ff3396ec9c9332008128897e5703cc6bb3817`. The `650ce59c` record remains historical supporting evidence. Scheduled Reports delivery and inbox receipt are separately certified by the Reports record, not by the Benchmark record.
