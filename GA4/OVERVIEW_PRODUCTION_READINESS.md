...
- Current Commit 4 is local-code validated only. Deployed Shopify delete/deactivate validation remains pending and must prove selected-source removal, exact revenue decrease, no unrelated source changes, and clean inventory after Render deploys the commit.
