...
Current status: **not production-ready and not clean-certified**. `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md` is canonical and supersedes the conclusion in this historical packet. The items below remain bounded evidence leads only.
...
Stable future answer: do not describe Shopify Revenue as closed, production-ready, or clean-certified unless the canonical Shopify readiness document's complete gate later passes.
