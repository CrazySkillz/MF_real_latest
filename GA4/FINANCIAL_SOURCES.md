...
- in the GA4 Revenue Sources modal, the Shopify edit control belongs beside the Shopify provider label; the mapped campaign label, Shopify amount, and source remove control must share the same name, amount, and action columns used by itemized CRM entries
