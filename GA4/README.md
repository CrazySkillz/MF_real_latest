...
- Current GA4 Insights spend boundary: Google Sheets and Upload CSV are enabled and must pass the revision-specific Insights certification. Google Ads, LinkedIn, Meta/Facebook, and Instagram are later-release connectors and must be absent from the live chooser and live Insights inputs.
...
- The current GA4 Insights new-spend chooser includes Google Sheets and Upload CSV. Google Ads, LinkedIn, Meta/Facebook, and Instagram are outside this release and absent from that chooser; their platform contexts must not feed GA4 Insights totals.
