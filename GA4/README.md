...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Current status: `PRODUCTION_READY` for exact deployed SHA `80ffc60c4ac38b8bb01a91373a6a41d552f066ad` and the recorded dependency/configuration boundary. Reports-owned behavior is outside this certification.
- `GA4/REPORTS.md`
...
- GA4 Insights live-tab status is `PRODUCTION_READY` for exact deployed SHA `80ffc60c4ac38b8bb01a91373a6a41d552f066ad`; `GA4/INSIGHTS_PRODUCTION_READINESS.md` is the sole controlling narrative source and `GA4/certifications/ga4-insights.json` is the machine record.
