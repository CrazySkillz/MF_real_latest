...
- GA4 Overview is not production-ready or clean-certified. Current Commits 1-4 are closed for their bounded packets. Current Commit 5 is implemented locally: new GA4 Google Sheets Revenue/Spend creation is hidden and API-blocked, and new GA4 CSV Spend requires a Date column. Deployment/UI validation and retained-source reconciliation remain open. The durable source of truth is `GA4/OVERVIEW_PRODUCTION_READINESS.md`.
