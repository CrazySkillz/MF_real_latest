...
- Shopify imported revenue follows the same GA4 source-backed financial model. Its current readiness status is **not production-ready and not clean-certified**; use `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md` as the canonical source instead of historical Shopify packets in this file.
