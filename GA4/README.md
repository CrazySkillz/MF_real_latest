...
- GA4 KPI whole-tab status is not production-ready and remains `UNVERIFIED`; `GA4/KPIS_PRODUCTION_READINESS.md` is controlling. Earlier notification, inventory, PDF, scheduler, email, and report packets are historical evidence and must be rerun where the current dependency/parity matrix requires them.
