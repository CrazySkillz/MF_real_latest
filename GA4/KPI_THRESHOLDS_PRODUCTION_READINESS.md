...
> Current durable whole-tab answer: GA4 KPIs are **PRODUCTION_READY** for the recorded boundary at deployed runtime `892ff3396ec9c9332008128897e5703cc6bb3817`; use `GA4/KPIS_PRODUCTION_READINESS.md` for the controlling evidence and exclusions. Historical threshold evidence cannot broaden that boundary.
