...
- For the GA4 Benchmark whole-tab certification, `GA4/BENCHMARKS_PRODUCTION_READINESS.md` is controlling. GA4 Benchmarks are clean-certified and `PRODUCTION_READY` for exact deployed runtime SHA `650ce59c4b0d14a21a198e8a2effd0c3a6d1fccd` and that documented boundary. Historical controlled Benchmark alert-email evidence remains bounded; scheduled Reports delivery and inbox receipt are outside this Benchmark certification and are not certified by it.
