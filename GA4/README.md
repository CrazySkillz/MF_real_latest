...
- Overview is **UNVERIFIED for current production certification** at user-confirmed deployed runtime `82fc3a7887d14e370e29a27ae4349333bacc2f58`. Current authenticated UI/API/source parity and the read-only production-data inventory passed for campaign `8aa735ee-c02f-41e2-bb1f-7c3f43bb9458`, live property `542352127`, and the recorded source set. Campaign Breakdown reconciled exactly, and the deployed copy now distinguishes 30-day GA4 row metrics from exact campaign-matched source-to-date imported revenue. The sole remaining external gate is one natural `22:00 UTC` target-persistence observation. The prior `ee22f0e470826f1cb247115497c9a15229d0142d` certification is historical only.
