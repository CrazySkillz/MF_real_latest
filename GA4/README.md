...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Current status: `PRODUCTION_READY` for exact deployed SHA `1ae85d88928e306e52f02d7a0e3c1ecd9ad5719e` and the recorded dependency/configuration boundary. Reports-owned behavior is outside this certification.
- `GA4/REPORTS.md`
