...
export function ColumnMappingInterface({
  ...
  // IMPORTANT: For LinkedIn, we always want the guided step-by-step wizard UX.
  // This prevents any remaining entry point from showing the all-in-one mapper.
  const platformLower = (platform || '').toLowerCase();
  const isLinkedIn = platformLower.includes('linkedin');
  if (isLinkedIn && connectionId) {
    return (
      <GuidedColumnMapping
  ...
  // NOTE: platformLower/isLinkedIn defined above for the LinkedIn wizard redirect.
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          >
            ...
            onClick={async () => {
              ...
              // Navigate immediately - the data will refresh on the Overview tab
              setTimeout(() => {
