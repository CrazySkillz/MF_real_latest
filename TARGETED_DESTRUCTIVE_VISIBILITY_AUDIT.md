...
The next safest smallest step is item 1: legacy/stale route and schema/storage cleanup. Start with a read-only reachability inventory before changing or deleting any code.
