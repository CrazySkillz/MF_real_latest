...
- `GA4/BENCHMARKS_PRODUCTION_READINESS.md`
  Canonical whole-tab Benchmarks production-readiness source of truth. Current status: release-candidate ready at exact implementation SHA `3d76226014395f2b04b3b1a52730488a6d5ba581`, with machine status `UNVERIFIED`; the `650ce59c` certification is historical only. Reports generation/delivery is separate.
...
- GA4 Benchmark whole-tab status is release-candidate ready at exact implementation SHA `3d76226014395f2b04b3b1a52730488a6d5ba581`, while the machine record remains `UNVERIFIED`; the exact `650ce59c` certification is historical only. Reports is assessed separately and is not certified by the Benchmark record.
