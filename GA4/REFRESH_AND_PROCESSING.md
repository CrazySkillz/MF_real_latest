...
Whole-Overview Commit 14 is closed at pushed commit `f8b51e31`. Commit 15 scope fix `03930b1c` deployed runner `2026-07-31.11`; its authenticated pack exposed a validation-only missing-field false zero. Runner `2026-07-31.12` locally parses `spendToDate`, preserves missing totals as `null`, and requires financial parity before passing. It does not change scheduler cadence, refresh behavior, provider calls, persistence, token handling, visible calculations, or production data. Commit/deployment and live 90-day, timer-fired, automatic-renewal, and more-than-seven-day OAuth evidence remain unproven.
