...
| GA4 KPIs | `UNVERIFIED` | `GA4/certifications/ga4-kpis.json`; `GA4/OVERVIEW_KPIs_CERTIFICATION_2026-09-15.md` | Shared provider-window, financial-source, current-value, Insights, and report-consumer dependencies changed after certified runtime `f7afeb2b`. Focused current-revision and exact deployed validation are required before certification can be restored. |
