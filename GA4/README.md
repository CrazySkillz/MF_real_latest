...
- HubSpot-specific report value propagation is locally guarded in Current Commit 4.12 by `GA4OverviewValidation.hubspotReportValuePack(...)` and static scheduled/server PDF formula checks; deployed report value evidence remains pending until the runner is executed against the configured GA4 report
