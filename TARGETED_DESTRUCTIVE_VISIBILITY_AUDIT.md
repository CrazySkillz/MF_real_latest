...
1. Custom Integration source mutation pass.
   Scope: Custom Integration connect/disconnect/read/edit/delete/refresh-style source mutation routes.
   Goal: prove custom source actions are campaign-scoped and only delete/update their own records.

2. Campaign/client delete cascade pass.
...
3. Legacy/stale route and schema/storage cleanup.
...
The next safest smallest step is item 1: audit Custom Integration source mutation paths.
