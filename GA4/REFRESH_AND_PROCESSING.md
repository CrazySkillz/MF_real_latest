...
Current deployed scheduler record (`2026-08-10`): `GA4_DAILY_REFRESH_TIME_ZONE=UTC`, `GA4_DAILY_REFRESH_HOUR=8`, `GA4_DAILY_REFRESH_MINUTE=0`, and `GA4_DAILY_REFRESH_RUN_ON_STARTUP=false`. The normal timer fired at `08:00:00.002Z`; target property `542352127` updated at `08:00:21.147`, retained 21 unique dates through `2026-08-09`, and had zero duplicate dates. The process-wide run failed 17 obsolete campaigns outside the certification, so no global-success claim is made.
