...
- Historical supporting evidence: post-`bf078b03` save-time alert processing, source-read reuse, immediate breach-episode behavior, and subject copy passed regression and deployed/provider validation at `a96ba06e21c9344c1767c960e702ac4a647dc5f1`. The current KPI certificate does not promote that earlier delivery event to exact-`f7afeb2b` delivery evidence.
