...
- Shopify Revenue status: **not production-ready and not clean-certified**. `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md` is canonical and supersedes the historical Shopify conclusions in this README and broader GA4 ledgers.
...
- Shopify-specific GA4 Overview readiness is tracked canonically in `GA4/OVERVIEW_REVENUE_SHOPIFY_PRODUCTION_READINESS.md`; historical packets elsewhere are bounded evidence, not a current certification.
