...
11. Current Commit 4.7d: HubSpot clean-certification update. Only after 4.7c passes, update this file with the validated provider/provenance/refresh evidence and mark HubSpot clean-certified for the exact proven campaign/provider scope. Do not use Google Sheets, CSV, KPI, Benchmark, Reports, or other source-family evidence as proof.
