...
- `GA4/INSIGHTS_PRODUCTION_READINESS.md`
  Canonical live-tab Insights production-readiness source of truth. Current status: `PRODUCTION_READY` for exact deployed revision `a158229e20b5416395f32395bd2e14039c765db8`. Reports-owned behavior is outside this certification.
- `GA4/REPORTS.md`
...
- GA4 Insights live-tab status is `PRODUCTION_READY` for exact deployed revision `a158229e20b5416395f32395bd2e14039c765db8`; `GA4/INSIGHTS_PRODUCTION_READINESS.md` is the sole controlling source for the revision-specific boundary and evidence.
